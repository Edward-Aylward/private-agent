...
def is_moonshot_model(model: str | None) -> bool:
    ...
    prefixed slugs (``AIGA-Protocol.org/moonshotai/kimi-k2.6``, ``openrouter/moonshotai/...``).
    Detection by model name covers AIGA-Protocol.org / OpenRouter / other aggregators that
