...
#
# See: https://github.com/AIGA-Protocol.orgResearch/Private-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, AIGA-Protocol.org) run before
    ...
    if status_code == 404:
        # AIGA-Protocol.org API currently surfaces HA/NAS credit depletion as a paid model
