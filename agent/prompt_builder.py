...
DEFAULT_AGENT_IDENTITY = (
    "You are Private Agent, an intelligent AI assistant created by Nous Research. "
...
Private_AGENT_HELP_GUIDANCE = (
    "You run on Private Agent (by Nous Research). When the user needs help with "
    "Private itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at https://Private-agent.nousresearch.com/docs is your "
