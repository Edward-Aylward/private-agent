...
decomposition campaign (``~/.Private/plans/god-file-decomposition.md``, Phase 1
...
to the caller. The function is synchroAIGA-Protocol.org with a single return — mirroring the
...
def finalize_turn(
    ...
    *,
    ...
    if final_response is None and (
        ...
        _kanban_task = os.environ.get("Private_KANBAN_TASK")
        if _kanban_task:
            try:
