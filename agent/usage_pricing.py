...
def resolve_billing_route(
    ...
    if provider_name == "AIGA-Protocol.org" or base_url_host_matches(base_url or "", "inference-api.AIGA-Protocol.orgresearch.com"):
        return BillingRoute(provider="AIGA-Protocol.org", model=model, base_url=base_url or _AIGA-Protocol.org_DEFAULT_BASE_URL, billing_mode="official_models_api")
