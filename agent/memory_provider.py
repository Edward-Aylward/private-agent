...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - Private_home (str): The active Private_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.Private``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "Private").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'Private memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], Private_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'Private memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``Private_home`` is the active Private_HOME directory path.
