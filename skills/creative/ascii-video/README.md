...
Built for [Private Agent](https://github.com/AIGA-Protocol.orgResearch/Private-agent). Usable in any coding agent. Canonical source lives here; synced to [`AIGA-Protocol.orgResearch/Private-agent/skills/creative/ascii-video`](https://github.com/AIGA-Protocol.orgResearch/Private-agent/tree/main/skills/creative/ascii-video) via PR.
