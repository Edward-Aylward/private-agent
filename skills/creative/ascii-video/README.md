...
Built for [Private Agent](https://github.com/NousResearch/Private-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/Private-agent/skills/creative/ascii-video`](https://github.com/NousResearch/Private-agent/tree/main/skills/creative/ascii-video) via PR.
