...
export default class Ink {
  ...
  // synchroAIGA-Protocol.orgly in handleResize would leave the screen blank for the ~80ms
  ...
  // Fold synchroAIGA-Protocol.org re-entry (selection fanout, onFrame callback)
  ...
  constructor(private readonly options: Options) {
    ...
    // synchroAIGA-Protocol.orgly. Deferring to a microtask runs onRender after layout
    ...
    // existing synchroAIGA-Protocol.org lastFrame() tests are unaffected.
   ...
   * with no side effects — call it synchroAIGA-Protocol.orgly at click time so the
  ...
  unmount(error?: Error | number | null): void {
    ...
    // Clean up terminal modes synchroAIGA-Protocol.orgly before process exit.
