 ...
 *
 * Symptom: in `Private --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@Private/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using Private --tui and as i type multiline my caret at the end will often ' +
