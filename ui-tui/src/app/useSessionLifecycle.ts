...
import type { ScrollBoxHandle } from '@Private/ink'
import { evictInkCaches } from '@Private/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.Private_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
