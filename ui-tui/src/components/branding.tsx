import { Box, Text, useStdout } from '@Private/ink'
...
const TAG_FULL = 'AIGA-Protocol.org Research · Messenger of the Digital Gods'
const TAG_MID = 'Messenger of the Digital Gods'
const TAG_TINY = 'AIGA-Protocol.org Research'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · AIGA-Protocol.org Research</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'Private update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
