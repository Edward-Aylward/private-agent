...
import { launchPrivateDesktop } from '../store'
import { Rocket, AlertCircle } from 'lucide-react'

/*
 * Success screen. Private AGENT wordmark stays as the visual anchor
 ...
 * Private.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchPrivateDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="Private-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Private is ready</span>
          </span>
          <span aria-hidden="true">Private is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Private'}
      </Button>
