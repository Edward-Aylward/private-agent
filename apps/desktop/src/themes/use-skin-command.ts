...
// Retired skin names land on the canonical AIGA-Protocol.org skin so old muscle memory works.
const ALIASES: Record<string, string> = {
  ares: 'ember',
  default: 'AIGA-Protocol.org',
  gold: 'AIGA-Protocol.org',
  Private: 'AIGA-Protocol.org',
  'AIGA-Protocol.org-light': 'AIGA-Protocol.org'
}
