...
const SIDEBAR_PINNED_STORAGE_KEY = 'Private.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'Private.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'Private.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'Private.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'Private.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'Private.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'Private.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'Private:focus-session-search'
