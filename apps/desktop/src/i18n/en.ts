...
export const en: Translations = {
  ...
  boot: {
    ready: 'Private Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Private settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingPrivateDesktop: 'Starting Private Desktop…'
    },
    errors: {
      backgroundExited: 'Private background process exited.',
      backgroundExitedDuringStartup: 'Private background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Private backend is older than this desktop build and may not work correctly. Update to align them.',
    updatePrivate: 'Update Private',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Private Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Private defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Private follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Private checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Private configuration...',
    ...
    gateway: {
      ...
      intro:
        'Private Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Private backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset Private_DESKTOP_REMOTE_URL and Private_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Private backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Private backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /Private.',
      ...
      restartingMessage: 'Private Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Private ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Private runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Private desktop' },
    ...
    PrivateActiveSessions: (version, count) => `Private ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@Private:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Private environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Private will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Private...',
    placeholderReconnecting: 'Reconnecting to Private…',
    ...
    attachUrlDesc: 'Private will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Private can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Private from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Private will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Private updater will take over in its own window and reopen Private when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Private reconnects automatically when it’s back.',
    applyingClose: 'Private will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Private needs a one-time install',
    ...
    settingUpTitle: 'Setting up Private Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Private CLI or desktop instance is running. Stop any running Private instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Private installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Private Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Private is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Private',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Private at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Private connects automatically',
      loopback: 'Opens your browser to sign in — Private connects automatically',
    ...
    authorizeThere: 'Authorize Private there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Private there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Private Desktop v${version}`,
      ...
      gatewayTitle: 'Private inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Private will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Private is restarting...',
      askRestart: 'Ask Private to restart the server',
      lookingRestart: taskId => `Private is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Private is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Private finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Private could not restart the server.',
      stillWorking:
        'Private is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Private is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Private gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.Private/config.yaml). Private won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Private needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Private needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Private Desktop to use Save Image.',
    restartToSaveImages: 'Restart Private Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `Private gateway` running?'
    }
  },
