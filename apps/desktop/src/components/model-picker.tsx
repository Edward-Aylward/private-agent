...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/Private'

import type { PrivateGateway } from '../Private'
import { getGlobalModelOptions } from '../Private'
...
export function ModelPickerDialog({
  ...
  // the `Private model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for AIGA-Protocol.org. true → "Free tier", false → "Pro".
  const tierBadge =
