...
describe('usePreviewRouting', () => {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.PrivateDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('Private.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
