import type { PrivateConfigRecord, ToolsetInfo } from '@/types/Private'
...
export function getNested(obj: PrivateConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: PrivateConfigRecord, path: string, value: unknown): PrivateConfigRecord {
...
function personalityOptions(config: PrivateConfigRecord): string[] {
