...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/Private'
 ...
 * log inline — the GUI equivalent of the install step `Private tools` runs
