...
import { deleteSession, listSessions, setSessionArchived } from '@/Private'
...
// / Program Files), which buried any files Private wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.PrivateDesktop` is
    ...
    const settings = window.PrivateDesktop?.settings
