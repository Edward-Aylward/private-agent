...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/Private'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('Private:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('Private:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
