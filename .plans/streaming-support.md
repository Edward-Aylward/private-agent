# Streaming LLM Response Support for Private Agent
...
```
Private_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("Private_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `Private_cli/config.py` | 1 | +streaming config defaults |
...
Private_STREAMING_ENABLED=true
```
