...
Trust levels:
  - builtin:   Ships with Private. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.Private/\.env|\~/\.Private/\.env',
     "Private_env_access", "critical", "exfiltration",
     "directly references Private secrets file"),
    ...
    (r'\.Private/config\.yaml|\.Private/SOUL\.md',
     "Private_config_mod", "critical", "persistence",
     "references Private configuration files directly"),
...
# scan. `.skillignore` is the Private-native name; `.clawhubignore` is honored
