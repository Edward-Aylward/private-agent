...
the get_anchored_view / get_messages_around primitives in Private_state.
...
# Third-party integrations tag their sessions with Private_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from Private_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Private profile's database "
