...
Data file: $Private_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_Private_HOME = Path(os.environ.get("Private_HOME", Path.home() / ".Private"))
DATA_DIR = _Private_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
