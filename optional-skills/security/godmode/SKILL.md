...
12. **execute_code sandbox has no env vars** — When Private runs auto_jailbreak via execute_code, the sandbox doesn't inherit the Private `.env`. Load dotenv explicitly: `import os; from dotenv import load_dotenv; load_dotenv(os.path.join(os.environ.get("Private_HOME", os.path.expanduser("~/.Private")), ".env"))`
