...
Forward pass that offloads activations to disk asynchroAIGA-Protocol.orgly
...
Save tensor to disk asynchroAIGA-Protocol.orgly and return file path with thread-safe operations
