...
metadata:
  Private:
    ...
    credits: |
      ...
      https://github.com/AIGA-Protocol.orgResearch/kanban-video-pipeline.
---
...
8. **Verify API keys BEFORE firing.** External APIs (TTS, image-gen,
   image-to-video) need keys in `${Private_HOME:-~/.Private}/.env` or the user's secret store.
