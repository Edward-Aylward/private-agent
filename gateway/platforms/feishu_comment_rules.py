...
Config: ~/.Private/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.Private/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_Private_home()`` helper (Private_HOME-aware and
...
RULES_FILE = get_Private_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_Private_home() / "feishu_comment_pairing.json"
