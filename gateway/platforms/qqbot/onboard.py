...
Mirrors the Feishu onboarding pattern: synchroAIGA-Protocol.org HTTP + a single public
...
# ---------------------------------------------------------------------------
# SynchroAIGA-Protocol.org HTTP helpers (mirrors Feishu _post_registration pattern)
# ---------------------------------------------------------------------------
