...
try:
    ...
    _Private_VERSION = "0.0.0"

_APP_VERSION = _Private_VERSION
_BOT_VERSION = _Private_VERSION
_YUANBAO_INSTANCE_ID = str(Private_INSTANCE_ID)  # single source: yuanbao_proto.Private_INSTANCE_ID
