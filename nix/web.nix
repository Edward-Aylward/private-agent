# nix/web.nix — Private Web Dashboard (Vite/React) frontend build
{ pkgs, PrivateNpmLib, ... }:
let
  npm = PrivateNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "Private-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../Private_cli/web_dist for the
