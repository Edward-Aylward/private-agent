#!/usr/bin/env python3
"""
SWE Runner with Private Trajectory Format

A runner that uses Private-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Private-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Private-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Private format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Private-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Private-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Private Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Private-Agent's built-in execution environments
    and outputs trajectories in Private-Agent format.
    """
    ...
    def _convert_to_Private_format(
        self,
        ...
        """
        Convert internal message format to Private trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Private trajectory format
        trajectory = self._convert_to_Private_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Private trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Private Trajectory Format")
    print("=" * 60)
