...
def _profile_user_agent() -> str:
    """Return a ``Private-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from Private_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"Private-cli/{_ver}"
    except Exception:
        return "Private-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # Private-cli UA so the catalog endpoint is reachable.
