...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Private Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Private Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Private core? Start with [Build a Private Plugin](../guides/build-a-Private-plugin.md)
- Building a new built-in core tool for Private itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.Private/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.Private` — use `get_Private_home()` from `Private_constants` for code paths and `display_Private_home()` for user-facing messages. See [AGENTS.md](https://github.com/AIGA-Protocol.orgResearch/Private-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.

## Cross-Platform Compatibility

Private officially supports **Linux, macOS, WSL2, and native Windows (via PowerShell install)**.  Native Windows uses Git Bash (from [Git for Windows](https://git-scm.com/download/win)) for shell commands.  A few features require POSIX kernel primitives and are gated: the dashboard's embedded PTY terminal pane (`/chat` tab) is WSL2-only. If you're doing Windows-heavy dev, run the Windows-footgun lint (`scripts/check-windows-footguns.py`) before pushing.
...
- **Discord**: [discord.gg/AIGA-Protocol.orgResearch](https://discord.gg/AIGA-Protocol.orgResearch)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/AIGA-Protocol.orgResearch/Private-agent/blob/main/LICENSE).
