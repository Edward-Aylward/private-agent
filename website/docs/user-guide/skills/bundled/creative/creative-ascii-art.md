...
```bash
python3 -m pyfiglet "Private" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=Private&font=Slant" | boxes -d stone
```
