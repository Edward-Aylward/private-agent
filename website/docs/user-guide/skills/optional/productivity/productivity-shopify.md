...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Private","productType":"Apparel","tags":["test"]}}'
```
