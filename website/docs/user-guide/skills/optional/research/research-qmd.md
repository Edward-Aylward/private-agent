...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/research/qmd` |
...
Private Agent via the native MCP client. This is the preferred
...
Then configure Private Agent to connect via HTTP:
