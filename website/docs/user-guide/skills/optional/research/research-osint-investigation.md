...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Private Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $Private_OSINT_CACHE/icij/ (default: ~/.cache/Private-osint/icij/).
...
# Set Private_OSINT_UA=your-app/1.0 (your@email) to identify yourself
