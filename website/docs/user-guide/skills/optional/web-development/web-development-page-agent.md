...
- User wants **Private itself to drive a browser** → use Private' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
