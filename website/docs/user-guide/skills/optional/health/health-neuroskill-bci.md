...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/health/neuroskill-bci` |
...
Connect Private to a running [NeuroSkill](https://neuroskill.com/) instance to read
