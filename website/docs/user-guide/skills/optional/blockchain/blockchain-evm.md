...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Private Agent |
| License | MIT |
...
Helper script path: `~/.Private/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.Private/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.Private/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.Private/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
