...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Private Agent |
| License | MIT |
...
The script reads `~/.Private/.env` for two optional defaults:
...
Helper script: `~/.Private/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.Private/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.Private/.env`.
...
```bash
python3 ~/.Private/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.Private/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
