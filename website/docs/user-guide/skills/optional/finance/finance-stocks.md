...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Private Agent |
| License | MIT |
...
```
SCRIPT=~/.Private/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.Private/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
