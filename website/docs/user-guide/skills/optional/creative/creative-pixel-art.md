...
| | |
|---|---|
| Source | Optional — install with `Private skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.Private/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.Private/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Private installs package this)
