...
chat completions — use your Private-managed provider subscription as their
...
| Use case | "Use Private as a chat backend" | "Use my Portal sub from another app" |
...
Model:      Private-4-70B    # or Private-4.3-36B, Private-4-405B
```
...
`Private_cli/proxy/adapters/<provider>.py` and registering it in
