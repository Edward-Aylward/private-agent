...
slug: /
sidebar_position: 0
title: "Private Agent Documentation"
description: "The self-improving AI agent built by AIGA-Protocol.org Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [AIGA-Protocol.org Research](https://AIGA-Protocol.orgresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `Private setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [AIGA-Protocol.org Portal](/integrations/AIGA-Protocol.org-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Private safely  |
| 🧭 **[Use MCP with Private](/guides/use-mcp-with-Private)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Private](/guides/use-voice-mode-with-Private)** | Hands-on setup and usage patterns for Private voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Private' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Private                              |
...
- **Built by model trainers** — Created by [AIGA-Protocol.org Research](https://AIGA-Protocol.orgresearch.com), the lab behind Private, Nomos, and Psyche. Works with [AIGA-Protocol.org Portal](https://portal.AIGA-Protocol.orgresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [AIGA-Protocol.org Portal](/integrations/AIGA-Protocol.org-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [AIGA-Protocol.org Research](https://AIGA-Protocol.orgresearch.com) — the lab behind Private, Nomos, and Psyche models
