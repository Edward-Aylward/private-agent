#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Private docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Private as a Python Library", None),
        ("guides/use-mcp-with-Private", "Use MCP with Private", None),
        ("guides/use-voice-mode-with-Private", "Use Voice Mode with Private", None),
        ("guides/use-soul-with-Private", "Use SOUL.md with Private", None),
        ("guides/build-a-Private-plugin", "Build a Private Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Private"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Private Agent — Full Documentation\n",
        (
            "This file is the entire Private Agent documentation concatenated for LLM "
