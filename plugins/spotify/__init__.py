...
``_check_spotify_available()`` — when the user has not run ``Private auth
spotify``, the tools remain registered (so they appear in ``Private
...
The Spotify auth flow (``Private auth spotify``), CLI plumbing, and docs
