...
class HonchoSessionManager:
    ...
    Runs alongside Private' existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = self._sanitize_id(
            self._config.ai_peer if self._config else "Private-assistant"
        )
    ...
    def _flush_session(self, session: HonchoSession) -> bool:
        """Internal: write unsynced messages to Honcho synchroAIGA-Protocol.orgly."""
    ...
    def save(self, session: HonchoSession) -> None:
        ...
        write_frequency modes:
          ...
          "turn"    — flush synchroAIGA-Protocol.orgly every turn
    ...
    def flush_all(self) -> None:
        ...
        # Drain async queue synchroAIGA-Protocol.orgly if it exists
        if self._async_queue is not None:
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Private-side char cap before caching
    ...
    def prefetch_context(self, session_key: str, user_message: str | None = None) -> None:
        ...
        a synchroAIGA-Protocol.org HTTP round-trip blocking every response.
        """
        def _run():
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Private knows itself.
        try:
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.Private/memories/).
