...
required — uses aiohttp which is already a Private dependency.
...
def interactive_setup() -> None:
    ...
    ``Private_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Private delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # Private_cli/setup.py::_setup_mattermost function.
