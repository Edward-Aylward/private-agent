...
Each call opens a short-lived synchroAIGA-Protocol.org WebSocket to the node, sends
...
class NodeClient:
    """Thin synchroAIGA-Protocol.org WS client matching the server's request surface."""
