# Private Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.Private/plugins/Private-achievements/scan_snapshot.json`.
...
- Refresh is asynchroAIGA-Protocol.org.
...
Acceptance:
- Checkpoint persisted at `~/.Private/plugins/Private-achievements/scan_checkpoint.json`.
