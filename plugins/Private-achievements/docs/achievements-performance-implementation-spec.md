# Private Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.Private/plugins/Private-achievements/state.json` (existing unlock state)
  - `~/.Private/plugins/Private-achievements/scan_snapshot.json` (new)
  - `~/.Private/plugins/Private-achievements/scan_checkpoint.json` (new)
