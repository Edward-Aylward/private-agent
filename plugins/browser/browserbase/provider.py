...
credentials. Managed AIGA-Protocol.org gateway support has been removed — the AIGA-Protocol.org
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only — managed-AIGA-Protocol.org-gateway support lives on the
