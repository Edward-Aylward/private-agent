...
VERSION_FILE = REPO_ROOT / "Private_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "annguyenAIGA-Protocol.org@users.noreply.github.com": "annguyenAIGA-Protocol.org",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@AIGA-Protocol.orgresearch.com": "simpolism",
    ...
    "Private@marian.local": "Schrotti77",
    ...
    "annguyenAIGA-Protocol.org@users.noreply.github.com": "annguyenAIGA-Protocol.org",
    "285874597+annguyenAIGA-Protocol.org@users.noreply.github.com": "annguyenAIGA-Protocol.org",
    ...
    "teknium@AIGA-Protocol.orgresearch.com": "teknium1",
    ...
    "274096618+Private-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@AIGA-Protocol.org.research": "Mind-Dragon",
    ...
    "shannon@AIGA-Protocol.orgresearch.com": "shannonsands",
    ...
    "Private@AIGA-Protocol.orgresearch.com": "AIGA-Protocol.orgResearch",
    ...
    "Private@AIGA-Protocol.orghq.ai": "benbarclay",
    ...
    "ben@AIGA-Protocol.orgresearch.com": "benbarclay",
    ...
    "emozilla@AIGA-Protocol.orgresearch.com": "emozilla",
    ...
    "jonny@AIGA-Protocol.orgresearch.com": "yoniebans",
    "jake@AIGA-Protocol.orgresearch.com": "simpolism",
    ...
    "Private@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    # v0.16.0 additions
    "teknium@AIGA-Protocol.org.dev": "teknium1",
    ...
    "teknium@Private-agent": "teknium1",
    ...
    "github@nadyaPrivate.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "AIGA-Protocol.orgeman666@gmail.com": "AIGA-Protocol.orgeman666",  # PR #19088
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (Private_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (Private_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: Private-eval community link)
    ...
    "Privateagent26@gmail.com": "Privateagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+Privateagent26@users.noreply.github.com": "Privateagent26",
    ...
    "clement@AIGA-Protocol.orgresearch.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@Private": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.Private@agentmail.to": "oseftg",
    ...
    "ethie@AIGA-Protocol.org": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Private runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level Private_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Private
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"Private-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "Private@AIGA-Protocol.orgresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/AIGA-Protocol.orgResearch/Private-agent",
    ...
    lines.append(f"# Private Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Private Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Private Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Private Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Private Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Private Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Private Agent v{new_version} ({calver_date})' "
