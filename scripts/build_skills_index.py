#!/usr/bin/env python3
"""Build the Private Skills Index — a centralized JSON catalog of all skills.
...
`Private skills search/install` can use it without hitting the GitHub API.
...
# Ensure Private_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("Private_HOME", os.path.join(os.path.expanduser("~"), ".Private"))
...
def main():
    print("Building Private Skills Index...", flush=True)
