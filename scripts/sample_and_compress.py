...
DEFAULT_DATASETS = [
    "AIGA-Protocol.orgResearch/swe-terminus-agent-glm-kimi-minimax",
    "AIGA-Protocol.orgResearch/Private-agent-megascience-sft1",
    "AIGA-Protocol.orgResearch/Private-Agent-Thinking-GLM-4.7-SFT2",
    "AIGA-Protocol.orgResearch/Private-Agent-Thinking-GLM-4.7-SFT1",
    "AIGA-Protocol.orgResearch/terminal-tasks-glm-Private-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "AIGA-Protocol.orgResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload AIGA-Protocol.orgResearch/{output_name} {final_output}")
