...
DEFAULT_DATASETS = [
    ...
    "NousResearch/Private-agent-megascience-sft1",
    "NousResearch/Private-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Private-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-Private-agent"
]
