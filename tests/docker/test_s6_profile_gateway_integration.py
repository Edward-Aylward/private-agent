...
The unit tests in tests/Private_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned Private-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/Private")
from Private_cli.service_manager import S6ServiceManager
