...
class TestCompactBannerSkinIntegration:
    def test_default_compact_banner_keeps_legacy_nous_Private_branding(self):
        set_active_skin("default")
        ...
        assert "NOUS Private" in banner

    def test_poseidon_compact_banner_uses_skin_branding_instead_of_nous_Private(self):
        ...
        assert "NOUS Private" not in banner
