...
def store(tmp_path, monkeypatch):
    ...
    ~/.Private/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at Private_state import time, before pytest's Private_HOME monkeypatch
    fires — the autouse fixture's Private_HOME override doesn't help here.)
    """
