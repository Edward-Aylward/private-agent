...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("Private_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("Private_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("Private_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
