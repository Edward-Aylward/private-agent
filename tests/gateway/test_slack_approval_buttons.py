...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "Private_approve_once" in action_ids
        assert "Private_approve_session" in action_ids
        assert "Private_approve_always" in action_ids
        assert "Private_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "Private_deny", "value": "session-key"}
