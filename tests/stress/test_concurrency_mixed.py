...
def worker_loop(worker_id: int, Private_home: str, result_file: str) -> None:
...
def reclaimer_loop(Private_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="Private_mixed_stress_")
    print(f"Private_HOME = {home}")
