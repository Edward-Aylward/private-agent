...
class FakeClient:
    ...
    drive the notification / server-request streams synchroAIGA-Protocol.orgly."""
...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_Private_tools_auto_accepts(self):
        """When codex elicits on behalf of Private-tools (our own callback),
