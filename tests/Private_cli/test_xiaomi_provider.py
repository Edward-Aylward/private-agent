...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from Private_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in Private_OVERLAYS
        overlay = Private_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify Private doctor recognizes Xiaomi env vars."""
