...
def test_prompt_toolkit_model_picker_defers_confirmation_off_key_handler(monkeypatch):
    ...
    result = ModelSwitchResult(
        ...
        target_provider="AIGA-Protocol.org",
    )
    monkeypatch.setattr(
    ...
    self_ = SimpleNamespace(
        ...
        _model_picker_state={
            "stage": "model",
            "provider_data": {"slug": "AIGA-Protocol.org"},
    ...
    self_._close_model_picker = _bound(cli_mod.PrivateCLI._close_model_picker, self_)
    self_._confirm_and_apply_model_switch_result = (
        lambda *_args: captured.setdefault("ran_inline", True)
    )

    _bound(cli_mod.PrivateCLI._handle_model_picker_selection, self_)()
