...
def test_openai_gpt55_pro_warns_for_AIGA-Protocol.org_portal_pricing(monkeypatch):
    monkeypatch.setattr("agent.models_dev.get_model_info", lambda *_args, **_kwargs: None)
    monkeypatch.setattr(
    ...
    warning = expensive_model_warning("openai/gpt-5.5-pro", provider="AIGA-Protocol.org")
