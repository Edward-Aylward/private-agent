...
The notice prints the most recent curator run summary on `Private update`,
...
session start) so users normally never see the rename map. `Private update`
