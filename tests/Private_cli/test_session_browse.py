"""Tests for the interactive session browser (`Private sessions browse`).
...
from Private_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """Private sessions browse should be parseable."""
