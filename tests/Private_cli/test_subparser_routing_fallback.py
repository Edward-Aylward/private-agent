...
The main() function in Private_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `Private -c model`
...
def _build_parser():
    """Build a minimal replica of the Private top-level parser."""
