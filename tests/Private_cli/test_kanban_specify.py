"""Tests for the specifier module + `Private kanban specify` CLI surface.
...
from Private_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `Private kanban …` argparse surface directly."""
