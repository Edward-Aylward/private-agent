"""
Private CLI - Unified command-line interface for Private Agent.

Provides subcommands for:
- Private chat          - Interactive chat (same as ./Private)
- Private gateway       - Run gateway in foreground
- Private gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `Private setup` on a fresh Pi.
    ...
    Private_cli/stdio.py::configure_windows_stdio() runs later from the entry
