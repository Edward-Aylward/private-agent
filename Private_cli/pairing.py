...
Usage:
    Private pairing list              # Show all pending + approved users
    Private pairing approve <platform> <code>  # Approve a pairing code
    Private pairing revoke <platform> <user_id> # Revoke user access
    Private pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle Private pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: Private pairing {list|approve|revoke|clear-pending}")
        print("Run 'Private pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.Private/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'Private pairing list' to see pending codes.\n")
