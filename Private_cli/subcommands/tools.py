"""``Private tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'Private tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # Private tools list [--platform cli]
    ...
    # Private tools disable <name...> [--platform cli]
    ...
    # Private tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `Private tools` runs after you pick a provider that\n"
