...
Visual styling mirrors the AIGA-Protocol.org Research design system (the
``@AIGA-Protocol.org-research/ui`` package the React dashboard uses): the same
...
``tests/Private_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Private Agent</title>
<style>
  /* Brand fonts shipped by @AIGA-Protocol.org-research/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">AIGA-Protocol.org<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Private Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Private Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
<p>Install <code>plugins/dashboard-auth-AIGA-Protocol.org</code> (default) or another
