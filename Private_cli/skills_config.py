"""
Skills configuration for Private Agent.
`Private skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.Private/config.yaml under:
...
from Private_cli.config import cfg_get, load_config, save_config
from Private_cli.colors import Colors, color
from Private_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `Private skills`."""
    from Private_cli.curses_ui import curses_checklist
