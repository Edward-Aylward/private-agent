...
def _has_Private_agent_browser() -> bool:
    ...
    # install.sh installs globally into $Private_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-PrivateHome", str(get_Private_home()),
        ]
    else:
