...
already in ``Private auth`` or ``Private tools``. It's the onboarding + discovery
...
def portal_command(args) -> int:
    """Top-level dispatch for `Private portal <subcommand>`."""
    ...
    print("Run `Private portal -h` for usage.", file=sys.stderr)
    return 1
