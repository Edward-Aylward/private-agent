...
Private is developed on Linux / macOS and tested natively on Windows too.
...
# Electron exits, so the gateway never gets respawned after a `Private
...
def windows_hide_flags() -> int:
    ...
    flash but also want to collect stdout/exit code synchroAIGA-Protocol.orgly.
