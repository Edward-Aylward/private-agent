...
Invoked by ``Private kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Private Agent board.
...
def _profile_author() -> str:
    """Mirror of ``Private_cli.kanban._profile_author``."""
    return (
