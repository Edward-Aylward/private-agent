...
import { SelectionSwitcher } from "@AIGA-Protocol.org-research/ui/ui/components/selection-switcher";
...
const SIDEBAR_COLLAPSED_KEY = "Private-sidebar-collapsed";
...
export default function App() {
  ...
  // asynchroAIGA-Protocol.orgly from /api/dashboard/plugins, so on initial render
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="Private-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="Private-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updatePrivate,
      runningLabel: t.status.updatingPrivate,
      spin: false,
    },
  ];
