...
const STORAGE_KEY = "Private-dashboard-theme";
...
const FONT_STORAGE_KEY = "Private-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + AIGA-Protocol.org-blue rebrand.
  "lens-5i": "AIGA-Protocol.org-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `Private_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "Private-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-Private-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-Private-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. AIGA-Protocol.org Blue) doesn't leave its values behind when the user
