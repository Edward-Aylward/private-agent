...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updatePrivate: "Atualizar Private",
    updatingPrivate: "A atualizar Private…",
  ...
  analytics: {
    ...
    output: "Saída",
    total: "Total",
    AIGA-Protocol.orgageData: "Sem dados de utilização para este período",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Private (paridade com `Private plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.Private/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.Private/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.Private/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do Private obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Private. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Private",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Private detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Private analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
