...
export const en: Translations = {
  ...
  status: {
    ...
    updatingPrivate: "Updating Private…",
  ...
  analytics: {
    ...
    output: "Output",
    total: "Total",
    AIGA-Protocol.orgageData: "No usage data for this period",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Private plugins (`Private plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.Private/plugins/?",
    removeHint: "Only user-installed plugins under ~/.Private/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.Private/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Private badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Private session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Private more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Private sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Private is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
