...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updatePrivate: "Private aktualisieren",
    updatingPrivate: "Private wird aktualisiert…",
  ...
  analytics: {
    ...
    output: "Ausgabe",
    total: "Gesamt",
    AIGA-Protocol.orgageData: "Keine Nutzungsdaten für diesen Zeitraum",
  ...
  pluginsPage: {
    ...
    headline:
      "Private-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `Private plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.Private/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.Private/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.Private/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Private-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Private-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Private mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Private ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Private scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
