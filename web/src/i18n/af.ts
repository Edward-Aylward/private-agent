...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updatePrivate: "Werk Private op",
    updatingPrivate: "Besig om Private op te werk…",
  ...
  analytics: {
    ...
    output: "Uitset",
    total: "Totaal",
    AIGA-Protocol.orgageData: "Geen gebruiksdata vir hierdie tydperk nie",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Private-inproppe op (`Private plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.Private/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.Private/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.Private/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Private-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Private-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Private meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Private 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Private skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
