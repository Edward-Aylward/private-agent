 ...
 * `window.__Private_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Private brand in the top bar
 ...
 *  `window.__Private_PLUGINS__.registerSlot(...)`.
 *
