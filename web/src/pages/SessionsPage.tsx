...
import { Segmented } from "@AIGA-Protocol.org-research/ui/ui/components/segmented";
...
import { Card, CardContent, CardHeader, CardTitle } from "@AIGA-Protocol.org-research/ui/ui/components/card";
...
import {
  ...
  DialogHeader,
  DialogTitle,
} from "@AIGA-Protocol.org-research/ui/ui/components/dialog";
    ...
    async (id: string) => {
      try {
        const res = await fetch(api.exportSessionUrl(id), {
          credentials: "include",
          headers: {
            "X-Private-Session-Token":
              (window as unknown as { __Private_SESSION_TOKEN__?: string })
                .__Private_SESSION_TOKEN__ ?? "",
          },
        });
